            ...
            <div class="p-4 text-center mt-5 text-dark fw-bold">
               ...
               <p class="text1 ">Forgot Password?</p>
                ...
                <div class="form-floating mb-3 ms-5 me-5">
                  ...
                  <div class="box2 d-grid gap-2 mb-3 ms-5 me-5 mt-3 rounded-3">
                  <a href="reset.php"><button class="btn text-light fs-4 fw-bold " type="submit">Next</button></a>
                  </div>
                  
                  <div class="">
                    <a href="index.php" class="text-dark text-decoration-none position-absolute bottom-0 start-0 mb-3 ms-3 fw-bold"><< Back</a>
                  </div>
