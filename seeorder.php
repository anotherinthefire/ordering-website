...
<body>
    <?php include("includes/nav-land.php");
    ...
    <div align="center" style="vertical-align: bottom; font-family: 'Montserrat', sans-serif; ">
        ...
        <table>
            ...
            <tr style="font-family: 'Montserrat', sans-serif; " class="link-no-decoration">
                    <td><b style="padding-left:20px; color: #5876C3;"><a href="pages/myorders.php">ALL</a></b></td>
                    <td style="height: 20px; padding-left: 120px; color: #4F4F4F;"><b><a href="pages/topay.php">TO PAY</a></b></td>
                    <td style="padding-left: 50px; color: #4F4F4F;"><b><a href="pages/toship.php">TO SHIP</a></b></td>
                    <td style="padding-left: 70px; color: #4F4F4F;"><b><a href="pages/toreceive.php">TO RECEIVE</a></b></td>
                    <td></td>
                    <td style="height: 20px; padding-left: 205px; color: #4F4F4F;"><b><a href="pages/completed.php">COMPLETED</a></b></td>
                </tr>
