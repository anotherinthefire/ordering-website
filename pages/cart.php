    ...
    <div style="text-align:center;">
            ...
            while ($row = mysqli_fetch_array($result)) { //loop start
                ?>
                            <tr class="Katekyo" style="border-bottom-width: 4.667; padding-bottom:10px;">
                                <td style="padding-left: 75px;"> <input type="checkbox" name="cart_item[]"
                                        value="<?php echo $row['cart_id']; ?>"></td>
                                <td style="padding-bottom: 30px;padding-top: 30px;">
                                    <img src="../../product_images/<?php echo $row['prod_img']; ?>"
                                ...
                                <td>
                                    ...
                                    <input type="text" id="quantity" name="quantity" value="<?php echo $row['quantity']; ?>"
                                        style="text-align: center; width:7vw;border-color: transparent;" readonly>
        ...
        if (isset($_SESSION['user_id'])) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                <button type="submit" name="checkout" value="Checkout" form="checkprod" class="btn btn-Primary"
                    style="padding-left: 25px; padding-right: 25px;border:2px solid transparent;">Checkout</button>
